...
type ActiveProject = { id: number; name: string; status: string; github_repo_url: string };
type Client = {
  id: number;
  name: string;
  company: string;
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-zinc-400 mt-1">Click a client to view full details.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        {clients.map((c) => (
          ...
          >
            ...
            <div className="mt-3 text-xs text-zinc-400">Email: {formatEmail(c.email)}</div>
            ...
            <div className="h-full flex flex-col p-5">
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-zinc-400">{selected.company}</div>
                  </div>
                </div>
              ...
              <div className="mt-5 space-y-4 overflow-auto">
                <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-4">
                  ...
                  <div className="text-sm font-medium mt-1">{formatEmail(selected.email)}</div>
                </div>

                <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-4">
                  <div className="text-sm font-semibold">Notes</div>
                  <div className="text-sm text-zinc-300 mt-2 whitespace-pre-wrap">{selected.notes}</div>
                </div>
